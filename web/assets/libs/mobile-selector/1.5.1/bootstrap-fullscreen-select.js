        ...
        _buildHTML: function () {
            ...
            if (this.$e.attr('data-triggerOn') === undefined) {
                ...
                if(this.classNames){
                    ...
                    tmp = $.grep(tmp, function(v,i){
                        return v !== 'mobileSelect' && v.indexOf('js-') !== 0;
                    });
                    this.classNames = tmp.join(' ');
                }
                
                var b = this.$e.attr('disabled') || '';
                this.$e.before('<button type="button" class="btn ' + this.style + ' ' + this.classNames + ' btn-mobileSelect-gen" '+b+'><span class="caret"></span><span class="text"></span></button>');
